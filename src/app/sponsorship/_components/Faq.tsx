...
const FAQS = [
  ...
  {
    question:
      "Posso effettuare una donazione e lasciare a voi l'organizzazione?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Attualmente non disponiamo di tier di sponsorship. Ogni sponsor ha la possibilità di contribuire in modo unico e personalizzato, garantendo un'esperienza di sponsorizzazione flessibile e su misura.",
  },
  {
    question:
      "Come posso fare se ho ulteriori domande che non sono state trattate in questa pagina?",
    answer:
