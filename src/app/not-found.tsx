        ...
        <div className="leading-8">
          ...
          <ul className="list-disc list-inside">
            <li>
              ...
              cliccando sul nostro logo o utilizzando il pulsante
              &quot;Home&quot; nella barra di navigazione.
            </li>
            ...
            <li>
              <Link href="/contatti">Contattaci</Link>: Se pensi che si tratti
              di un errore, ti preghiamo di contattarci e segnalare il problema.
              Saremo felici di assisterti.
            </li>
          </ul>
          <p className="mt-8">
            Ci scusiamo per l&apos;inconveniente. Grazie per la tua comprensione
            e per aver visitato il sito web.
          </p>
        </div>
      </div>
